...
`;
    ...
    describe("fetchSpecs", () => {
        ...
        it("should fetch the namespace specs", async () => {
            ...
            assert(s[4].metadata.name === "k8svent");
